...
{
    // Keep the baseline constructor on the compatibility source path.  In
    // particular, do not route it through semantic policy or telemetry code:
    // even small work in this hot path changes local-mapping thread scheduling.
    mnId=nNextId++;
